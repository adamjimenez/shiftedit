define(['exports',"./lang","./prefs","./tabs","./layout","./drop",'./restore','./recent','./repositories','./editors', './tree', './site', './shortcuts','./hash','./definitions','./find', './exit', './notes', './snippets', './resize','./splash', './appcache', './prompt', './git', './notifications', "jquery-ui-bundle"], function (exports, lang, preferences, tabs, layout, drop, restore, recent, repositories, editors, tree, site, shortcuts, hash, definitions, find, exit, notes, snippets, resize, splash, appcache, prompt, git, notifications) {
