...
firepad.ACEAdapter = (function() {
  ...
  ACEAdapter.prototype.registerUndo = function(undoFn) {
  	var ace = this.ace;
    return this.ace.undo = function(){ undoFn(); ace.renderer.scrollCursorIntoView(null, 0.5); };
  };

  ACEAdapter.prototype.registerRedo = function(redoFn) {
  	var ace = this.ace;
    return this.ace.redo = function(){ redoFn(); ace.renderer.scrollCursorIntoView(null, 0.5); };
  };
