...
,	_initContainer = function () {
		...
		// Adam Jimenez: the following line broke jQuery 3.0
...
,	initResizable = function (panes) {
		...
		$.each(panes, function (idx, pane) {
			...
			,	start: function (e, ui) {
					//transparent div over screen to fix iframe issues
					$t = $('<div style="position: absolute; top: 0; left: 0; right: 0; bottom: 0;"></div>').appendTo("body")
			...
			,	stop: function (e, ui) {
					$t.remove(); // remove transparent div
		...
		$N.queue(function( queueNext ){
			...
			if (s.minSize > s.maxSize) { // INSUFFICIENT ROOM FOR PANE TO OPEN!
				...
				if (!noAlert && o.tips.noRoomToOpen)
					$.layout.msg(o.tips.noRoomToOpen);
