...
(function() {
    ...
    this.expandSnippetForSelection = function(editor, options) {
        ...
        if (token && (is(token, "tag-name") || is(token, "tag-open") || is(token, "end-tag-open") || is(token, "tag-whitespace") || is(token, "attribute-name") || is(token, "attribute-value"))) {
        	scopes.push('html-tag');
        } else {
        	scopes = this.getActiveScopes(editor);
        }
...
define("ace/tern/tern_server",["require","exports","module","ace/range","ace/lib/dom"], function (require, exports, module) {
    ...
    function getCompletions(ts, editor, session, pos, prefix, callback) {
        console.log('get tern completions');
    ...
    function showType(ts, editor, pos, calledFromCursorActivity) {
        ...
        var cb = function (error, data, typeData) {
            ...
            setTimeout(function () {
                console.log('yo1');
                var place = getCursorPosForTooltip(editor);
    ...
    function getCursorPosForTooltip(editor) {
        ...
        var curleft = 0;
        var curtop = 0;
        if (editor.container.offsetParent) {
            do {
        ...
        var place = {};
        place.top = coords.pageY + 28;
        place.left = coords.pageX;
        return {
            left: place.left,
            top: place.top
        };
...
define("ace/tern/tern",["require","exports","module","ace/config","ace/snippets","ace/autocomplete/text_completer","ace/autocomplete","ace/tern/tern_server","ace/editor"], function (require, exports, module) {
    "use strict";
    ...
    Autocomplete.startCommand = {
        ...
        exec: function (editor, e) {
            ...
            editor.completers = [];
            completers.forEach(function(item) {
                editor.completers.push(item);
            });
    ...
    var onCursorChange_Tern = function (e, editor_getSession_selection) {
        //console.log('tern change cursor');
        var editor_for_OnCusorChange = this;
    ...
    config.defineOptions(Editor.prototype, "editor", {
            ...
            set: function (val) {
                ...
                if (val) {
                    createTernServer(function () {
                        ...
                        self.getSession().selection.on('changeCursor', onCursorChange_Tern.bind(self));
        ...
        enableSnippets: {
            ...
            value: false
                ...
                (function() {
                    require(["ace/tern/tern"], function() {});
                })();
