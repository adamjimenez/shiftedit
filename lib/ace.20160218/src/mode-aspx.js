...
define("ace/mode/vbscript_highlight_rules",["require","exports","module","ace/lib/oop","ace/lib/lang","ace/mode/doc_comment_highlight_rules","ace/mode/text_highlight_rules","ace/mode/html_highlight_rules"], function(require, exports, module) {
"use strict";
...
var VBScriptLangHighlightRules = function() {
...
oop.inherits(VBScriptLangHighlightRules, TextHighlightRules);

var AspxHighlightRules = function() {
    HtmlHighlightRules.call(this);

    var startRules = [
        {
            token : "support.aspx_tag", // aspx open tag
            regex : "<\\%(?:=)?",
            push  : "aspx-start"
        }
    ];
    ...
    var endRules = [
        {
            token : "support.aspx_tag", // aspx close tag
            regex : "\\%>",
            next  : "pop"
        }
    ];
    ...
    this.embedRules(VBScriptLangHighlightRules, "aspx-", endRules, ["start"]);

    this.normalizeRules();
};

oop.inherits(AspxHighlightRules, HtmlHighlightRules);

exports.AspxHighlightRules = AspxHighlightRules;
exports.VBScriptLangHighlightRules = VBScriptLangHighlightRules;
});
...
define("ace/mode/aspx",["require","exports","module","ace/lib/oop","ace/mode/text","ace/mode/vbscript_highlight_rules","ace/mode/vbscript_highlight_rules","ace/mode/matching_brace_outdent","ace/range","ace/worker/worker_client","ace/mode/behaviour/cstyle","ace/mode/folding/cstyle","ace/unicode","ace/mode/html","ace/mode/javascript","ace/mode/css"], function(require, exports, module) {
"use strict";

var oop = require("../lib/oop");
var TextMode = require("./text").Mode;
var AspxHighlightRules = require("./vbscript_highlight_rules").AspxHighlightRules;
var VBScriptLangHighlightRules = require("./vbscript_highlight_rules").VBScriptLangHighlightRules;
var MatchingBraceOutdent = require("./matching_brace_outdent").MatchingBraceOutdent;
var Range = require("../range").Range;
var WorkerClient = require("../worker/worker_client").WorkerClient;
var CstyleBehaviour = require("./behaviour/cstyle").CstyleBehaviour;
...
var AspxMode = function() {
    this.HighlightRules = VBScriptLangHighlightRules;
};
oop.inherits(AspxMode, TextMode);
...
(function() {
    ...
    this.$id = "ace/mode/aspx-inline";
}).call(AspxMode.prototype);

var Mode = function(opts) {
    if (opts && opts.inline) {
        var mode = new AspxMode();
        mode.createWorker = this.createWorker;
        mode.inlineAspx = true;
        return mode;
    }
    HtmlMode.call(this);
    this.HighlightRules = AspxHighlightRules;
    this.createModeDelegates({
        "js-": JavaScriptMode,
        "css-": CssMode,
        "aspx-": AspxMode
    });
    this.foldingRules.subModes["aspx-"] = new CStyleFoldMode();
};
