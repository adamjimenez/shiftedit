define(['app/config', 'app/loading', 'app/util', 'app/prefs', 'app/lang', 'app/prompt', 'app/ssh', 'jquery'], function (config, loading, util, preferences, lang, prompt, ssh) {
...
$('body').on('click', '#servers a', function(e){
	open();
});
